...
public class Mitarbeiter implements Serializable {
    ...
    public void saveNew() {
        ...
        context.addMessage(null, new FacesMessage("Mitarbeiter hinzugefügt", "Aktualisieren sie die Seite um die Änderungen zu sehen")); //Send message 
        update();
    }
    ...
    public void save() {
        ...
        bmwUserController.saveNew(null);
        FacesContext context = FacesContext.getCurrentInstance();
        context.addMessage(null, new FacesMessage("Mitarbeiter geändert", "Erfolgreich geändert!")); //Send message 
